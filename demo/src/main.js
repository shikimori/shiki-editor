...
const TRANSLATIONS = {
  ...
  'frontend.shiki_editor.smiley': 'Смайлики',
  'frontend.shiki_editor.image': 'Картинка',
  'frontend.shiki_editor.upload': 'Загрузка картинки',
  'frontend.shiki_editor.spoiler_block': 'Блок спойлера',
  'frontend.shiki_editor.code_block': 'Блок кода',
  'frontend.shiki_editor.bulle_list': 'Список',
