    ...
    describe('quote', () => {
      it('[quote]z[/quote]', () => {
        expect(MarkdownTokenizer.parse('[quote]z[/quote]')).to.eql([
          ...
          ...text('z'),
          { type: 'quote', direction: 'close', attrs: n() }
        ]);
      });
      ...
      it('[quote]\\nz\\n[/quote]', () => {
        expect(MarkdownTokenizer.parse('[quote]\nz\n[/quote]')).to.eql([
          ...
          ...text('z'),
          { type: 'quote', direction: 'close', attrs: n(false, true, true) }
        ]);
      });
    ...
    describe('bold_block', () => {
      it('[b]\\nz\\n[/b]', () => {
        expect(MarkdownTokenizer.parse(
          ...
          ...text('z'),
          { type: 'bold_block', direction: 'close', attrs: n(false, true, true) }
        ]);
      });
      ...
      it('[b][quote]z[/quote][/b]', () => {
        expect(MarkdownTokenizer.parse(
          ...
          ...text('z'),
          { type: 'quote', direction: 'close', attrs: n() },
          { type: 'bold_block', direction: 'close', attrs: n() }
        ]);
      });
      ...
      it('[b]\\n[quote]\\nz\\n[/quote]\\n[/b]', () => {
        expect(MarkdownTokenizer.parse(
          ...
          ...text('z'),
          { type: 'quote', direction: 'close', attrs: n(false, true) },
          { type: 'bold_block', direction: 'close', attrs: n(false, true, true) }]);
      });
  ...
  describe('complex cases', () => {
    it('outside broken formatting', () => {
      expect(MarkdownTokenizer.parse(
        ...
        ...text('z'),
        { type: 'center', direction: 'close', attrs: n() },
        ...text('[/i]')
      ]);
    });
    ...
    it('treat new line after [hr]', () => {
      expect(MarkdownTokenizer.parse(
        ...
        ...text('z'),
        { type: 'spoiler_block', direction: 'close', attrs: n() }
      ]);
    });
  });
});
